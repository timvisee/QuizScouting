...
class PageHeaderBuilder {
    ...
    public function build() {
        ...
        if($this->hasBackButton())
            echo '<a href="' . $this->getBackButton() . '" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-icon-back ui-btn-icon-left" data-direction="reverse">Terug</a>';
        ...
        echo '<h1 style="color: #' . $headerColor . '; text-shadow: 0 1px 0 #' . $headerColorShadow . ';">' . $headerTitle . '</h1>';
